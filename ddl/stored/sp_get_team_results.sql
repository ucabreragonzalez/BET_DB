...
create procedure sp_get_temp_results(in in_match_dt date, in in_home_team_nm varchar(20), in in_away_team_nm varchar(20), in in_prev_matches int, in in_prev_days int)
begin
